<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Historical Places2.aspx.cs" Inherits="Historical_Places" %>
...
<h1 class="style1">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            <asp:Panel ID="Panel1" runat="server">
                     ...
                     <p style="color: #FF3399; font-size: x-large;">
                         Elephanta Caves</p>
                     <p class="style4">Address:- Raigad, Gharapuri, Mumbai, Maharashtra 400094, India</p>
                            <asp:AdRotator ID="AdRotator1" runat="server" 
                        AdvertisementFile="~/XMLFile.xml" AlternateTextField="alternatetext" 
                        Height="200px" ImageUrlField="imageurl" NavigateUrlField="nevegateurl" 
                        Width="550px" />
                    <br />
        ...
        <asp:View ID="View2" runat="server">
            ...
            <p style="color: #FF3399; font-size: x-large;">
                         Gateway Of India</p>
                     <p class="style4">Address:- <span>Apollo Bunder, Colaba, Mumbai, Maharashtra 400001, 
                         India</span></p>
        ...
        <asp:View ID="View3" runat="server">
            ...
            <p style="color: #FF3399; font-size: x-large;">
                     ...
                     <p class="style4">Address:- <span class="style7"><span>&nbsp;</span></span><span 
                             class="entity-header-text"><span>South Mumbai, Mumbai, Maharashtra 400001, 
                         India</span></span></p>
        ...
        <asp:View ID="View4" runat="server">
            ...
            <p style="color: #FF3399; font-size: x-large;">
                     ...
                     <p class="style4">Address:- <span>M.G. Road, Fort, Mumbai, Maharashtra 400032, India</span></p>
...
A sneak peek into its history would tell you that the place, designed by Gilbert Scott, was earlier known as University of Bombay and it got its present name in the year 1996. National Assessment and Accreditation Council (NAAC) has given the highest rating, ‘A’ to Mumbai University. Founded by Dr. John Wilson in 1832, today the University stands tall with all its glory and success stories.<br /><br />
        ...
        <asp:View ID="View5" runat="server">
            ...
            <p style="color: #FF3399; font-size: x-large;">
                     ...
                     <p class="style4">Address:- <span>Next to High Court, Fort Campus, Mumbai, 
                         Maharashtra 400001, India</span></p>
                            <asp:AdRotator ID="AdRotator5" runat="server" 
                        AdvertisementFile="~/XMLFile.xml" AlternateTextField="alternatetext" 
                        Height="200px" ImageUrlField="imageurl" NavigateUrlField="nevegateurl" 
                        Width="550px" />
                    <br />
